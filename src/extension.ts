...
export function activate(context: vscode.ExtensionContext) {
	...
	/*
	let provider1 = vscode.languages.registerCompletionItemProvider('markdown', {
	...
	const provider2 = vscode.languages.registerCompletionItemProvider('markdown', {
		...
		...triggerCharacters // triggered whenever a '.' is being typed
	);
